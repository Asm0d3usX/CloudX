...
// 🌟 Plugin PusatFilm untuk CloudStream3
class Pusatfilm : MainAPI() {

    override var mainUrl = "http://v1.pusatfilm21info.net" // 🌐 URL utama
    override var name = "Pusatfilm" // 🏷️ Nama plugin
    override val hasMainPage = true
    override var lang = "id" // 🇮🇩 Bahasa Indonesia
    override val supportedTypes =
        setOf(TvType.Movie, TvType.TvSeries, TvType.Anime, TvType.AsianDrama) // 🎬 Jenis konten

    // 📄 Halaman utama dengan kategori
    ...
    // 🔍 Convert HTML element ke SearchResponse
