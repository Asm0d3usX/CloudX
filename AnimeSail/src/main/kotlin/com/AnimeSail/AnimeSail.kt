...
class AnimeSail : MainAPI() {
    ...
    companion object {
        // 🔍 Menentukan jenis anime berdasarkan teks
    ...
    // 🌐 Fungsi request untuk ambil halaman dengan header & cookie
    ...
    // 🏠 Daftar kategori utama di halaman depan
    ...
    // 📺 Mengambil daftar anime di main page
    ...
    // 🔗 Memperbaiki URL anime agar valid
    ...
    // 🔍 Mengubah elemen HTML menjadi hasil pencarian anime
    ...
    override suspend fun load(url: String): LoadResponse {
        ...
        // 🎬 Mapping episode (reversed agar urutan benar)
    ...
    // 🔗 Memuat link streaming dari berbagai mirror
    override suspend fun loadLinks(
        ...
        // ⚙️ Paralel memproses setiap mirror link
        coroutineScope {
    ...
    // 🎚️ Deteksi kualitas video dari teks (contoh: 720p, 1080p)
    private fun getIndexQuality(str: String?): Int {
        return Regex("(\\d{3,4})[pP]").find(str ?: "")?.groupValues?.getOrNull(1)?.toIntOrNull()
            ?: Qualities.Unknown.value
    }

    // 🧩 Loader tambahan untuk extractor eksternal
