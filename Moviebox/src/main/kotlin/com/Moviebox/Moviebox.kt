// 🎬 MainAPI - Moviebox Plugin untuk Cloudstream
// --------------------------------------------------
// 📦 Package utama
...
// 🚀 Kelas utama untuk Moviebox API
class Moviebox : MainAPI() {

    // 🌐 URL dasar & konfigurasi utama
    ...
    // 📡 Ambil daftar konten untuk halaman utama
    ...
    override suspend fun load(url: String): LoadResponse {
        ...
        return if (tvType == TvType.TvSeries) {
            val episode = document?.resource?.seasons?.map { seasons ->
                (if (seasons.allEp.isNullOrEmpty()) (1..seasons.maxEp!!)
    ...
    data class Items(
        ...
        // 🧠 Konversi item menjadi SearchResponse
