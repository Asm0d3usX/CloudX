 ...
 *  🎬 LayarMovie - MainAPI
 *  --------------------------------------------
 *  Mengambil data film dan drama dari situs
 *  utama LayarMovie (berbasis WordPress / Muvipro).
 *
 *  Fitur:
 *  - Home page kategori
 *  - Pencarian
 *  - Detail Movie / TV Series
 *  - Pemrosesan link streaming & download
 * ============================================
 */

class LayarMovie : MainAPI() {

    override var name = "LayarMovie"
    override var mainUrl = "http://139.59.58.240" // bisa diganti domain aktif
    ...
    override suspend fun load(url: String): LoadResponse {
        ...
        val title = document.selectFirst("h1.entry-title")
            ?.text()?.substringBefore("Season")?.substringBefore("Episode")?.trim().orEmpty()
    ...
    override suspend fun loadLinks(
        ...
        if (id.isNullOrEmpty()) {
            ...
            // 🔁 Load konten AJAX player (muvipro)
        ...
        // 💾 Tambahkan link download jika tersedia
