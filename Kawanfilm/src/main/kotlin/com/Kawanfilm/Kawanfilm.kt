// 🎬 KawanFilm API
// Plugin utama untuk situs KawanFilm — menampilkan film, drama, dan serial TV.
// ✨ Menyediakan dukungan penuh untuk halaman utama, pencarian, dan streaming link.
...
class Kawanfilm : MainAPI() {
    ...
    override var mainUrl = "https://tv2.kawanfilm21.co" // 🌐 URL utama
    private var directUrl: String? = null // 🔗 Base direct URL
    override var name = "Kawanfilm" // 🏷️ Nama provider
    override val hasMainPage = true // ✅ Ada main page
    override var lang = "id" // 🇮🇩 Bahasa Indonesia
    override val supportedTypes = setOf(TvType.Movie, TvType.TvSeries, TvType.Anime, TvType.AsianDrama) // 🎬 Tipe konten
    ...
    // 🔎 Konversi elemen ke search result
    ...
    // 🔁 Konversi elemen ke recommended
