...
// 🌸 Plugin utama Oploverz — Menyediakan anime sub Indo berkualitas tinggi!
class Oploverz : MainAPI() {
    ...
    companion object {
        // 🎬 Menentukan tipe anime (Movie, OVA, atau Serial TV)
        ...
        // ⏳ Menentukan status anime (Berlangsung / Tamat)
    ...
    // 📄 Mengambil daftar anime di halaman utama
    ...
    // 🔍 Mengubah data JSON ke format SearchResponse
    ...
    // 🧩 Mengambil teks dari elemen HTML tertentu
    ...
    // 🎥 Memuat detail anime (poster, genre, tahun, episode, dll)
    override suspend fun load(url: String): LoadResponse {
        ...
        // 📦 Mengembalikan data lengkap anime
    ...
    // 🔗 Mengambil semua link video dari setiap server
    ...
    // 🧠 Fungsi tambahan untuk menyesuaikan extractor
    ...
    // 📺 Mengonversi teks kualitas video jadi angka
    ...
    // 🧩 Data Classes — Menyimpan struktur JSON dari API Oploverz
    data class Sources(
