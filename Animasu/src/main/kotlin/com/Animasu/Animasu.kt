...
/** 🎌 Main Provider: Animasu (Anime Sub Indo) **/
class Animasu : MainAPI() {
    ...
    companion object {
        /** 🎭 Deteksi tipe anime (Series / Movie / OVA) **/
    ...
    /** 📋 Ambil daftar anime di halaman utama **/
    ...
    /** 🧭 Perbaiki link anime jika masih menuju halaman episode **/
    ...
    /** 🔍 Parsing hasil pencarian atau list anime menjadi SearchResponse **/
    ...
    override suspend fun load(url: String): LoadResponse {
        ...
        // 🧠 Dapatkan data tambahan dari MAL/AniList
    ...
    /** 🔗 Load semua extractor dari halaman streaming **/
    ...
    /** ⚙️ Load extractor dengan perbaikan kualitas otomatis **/
