...
/** 
 * 🧩 Kumpulan extractor untuk berbagai sumber streaming 
 * yang digunakan di plugin DutaMovie.
 */

// ----------------------------- //
// 🟢 BASE CLASS — Dingtezuni
// ----------------------------- //
open class Dingtezuni : ExtractorApi() {
    ...
    override suspend fun getUrl(
        ...
        // M3U8 link bisa diawali 'file:', 'hls2:', atau 'hls4:'
